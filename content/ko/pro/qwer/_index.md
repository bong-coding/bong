...
The Movie Database(TMDb) 및 Kakao API를 활용하여 사용자 맞춤 영화 탐색, 위시리스트, 다국어 지원, 소셜 로그인 기능까지 제공하는 반응형 웹 서비스입니다.
...
프로젝트는 **GitHub Actions**를 활용해 자동화된 빌드, 테스트, 배포 파이프라인을 구성하였습니다.
...
프로젝트는 **Git Flow 전략**을 도입하여 체계적인 버전 관리와 협업을 위한 브랜치 전략을 적용하였습니다.
